...
Breast cancer is the most commonly diagnosed cancer in U.S. women and a leading cause of cancer death.¹ Its rates are not the same across racial and ethnic groups. In the American Cancer Society's 2024 report, non-Hispanic Black (NHB) women had breast cancer incidence about 5% lower than non-Hispanic White (NHW) women but 38% higher mortality.¹ NHB women also have the highest rate of triple-negative breast cancer (TNBC),² and in several minority groups breast cancer has been reported at younger ages at diagnosis than in NHW women.³

Race and ethnicity are recorded in a few broad categories, and rates differ within each. The AANHPI category—Asian American, Native Hawaiian, and Pacific Islander—is a clear example. Treated as one population its incidence sits well below that of NHW women, but that single number covers a wide spread. Using California registry data, Gomez and colleagues⁵ reported an incidence of 146 per 100,000 in NHW women and, within Asian American women, a more-than-twofold spread across ethnic groups—from about 103 per 100,000 in Japanese to 46 in Korean women—that widened with US nativity, the rate in US-born Filipina women surpassing that of NHW women. Some of the lowest reported rates are among Southeast Asian groups such as the Hmong,⁶ and rates have differed again across the individual Asian ethnicities followed over time.⁷ Hispanic/Latina women are not one group either: incidence has been reported to differ by country of origin,⁸ and among California Hispanic women to vary further with nativity and neighborhood.⁹ For American Indian and Alaska Native (AI/AN) women, the aggregate rate also depends on how race is ascertained: registries that assign race by observation misclassify and undercount many AI/AN cases, so an unlinked-registry rate could understate their true incidence.¹⁰ Subtype may reorder the groups again: NHW women have been reported to have the highest rate of HR+/HER2− disease and NHB women the highest rate of TNBC,² so the group with the highest rate can depend on the subtype considered.
