...
- 대표값 재선정: 진짜 IHS-PRCDA national 자료인 Melkonian 2019(rec 2510, breast RR 0.87 vs NHW, 원문 "Non-Hispanic white was chosen as the reference")가 AI/AN aggregate 대표가 됨. 0.56 → 0.87. 원문에 CI, case count가 없어 point estimate로 제시(피드백 4항 취지와 일치, 근사 계산 안 함).
