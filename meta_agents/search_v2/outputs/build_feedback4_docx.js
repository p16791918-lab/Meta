// Convert outputs/Feedback4_response.md to Feedback4_Response.docx (plain, black).
const fs = require("fs");
const path = require("path");
const { Document, Packer, Paragraph, TextRun } = require("docx");

const FONT = "Malgun Gothic";
const SRC = path.join(__dirname, "Feedback4_response.md");
const OUT = path.join(__dirname, "Feedback4_Response.docx");
...
Packer.toBuffer(doc).then((buf) => {
  ...
  console.log("wrote Feedback4_Response.docx");
});
