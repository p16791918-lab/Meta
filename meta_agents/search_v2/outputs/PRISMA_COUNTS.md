...
- Report Embase as "Advanced Search, n = 3,248"; report PubMed/MEDLINE as one
  source (not two).
- The 55 extracted studies contributed 206 estimates; 24 studies supplied at
  least one main-analysis representative (83 representative estimates in all, one per analytic
  cell), and the remaining 31 studies contributed only overlapping estimates carried in the
