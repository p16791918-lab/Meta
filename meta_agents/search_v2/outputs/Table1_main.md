...
Values are the representative population-based estimate per group (one per analytic cell). Every representative is an incidence rate ratio. RoB = risk of bias. † reference is an unstratified White group (not NHW). ‡ 95%% CI computed by the review (delta method from the source's rate CIs, or a Poisson approximation), not reported directly; all unmarked CIs are as reported in the source.
...
| Group | Effect | Estimate [95% CI] | Representative study | Registry | RoB |
|----|----|----|----|----|----|
| Middle Eastern | IRR | 0.86 [0.84, 0.88] | Nasseri2009 (1988-2004) | California-CCR | Moderate |

**Triple-negative breast cancer**

| Group | Effect | Estimate [95% CI] | Representative study | Registry | RoB |
|----|----|----|----|----|----|
| Chinese | IRR | 0.53 [0.31, 0.93] † ‡ | Loo2019_HTR (2010-2013) | Hawaii Tumor Registry (SEER) | Low |
...
| Filipina | IRR | 0.84 [0.60, 1.18] † ‡ | Loo2019_HTR (2010-2013) | Hawaii Tumor Registry (SEER) | Low |
...
| Native Hawaiian | IRR | 0.86 [0.60, 1.22] † ‡ | Loo2019_HTR (2010-2013) | Hawaii Tumor Registry (SEER) | Low |
| Japanese | IRR | 1.08 [0.79, 1.46] † ‡ | Loo2019_HTR (2010-2013) | Hawaii Tumor Registry (SEER) | Low |
