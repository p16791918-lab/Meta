// Convert outputs/Changes_for_review.md to Changes_for_review.docx (plain, black).
const fs = require("fs");
const path = require("path");
const { Document, Packer, Paragraph, TextRun } = require("docx");

const FONT = "Malgun Gothic";
const SRC = path.join(__dirname, "Changes_for_review.md");
const OUT = path.join(__dirname, "Changes_for_review.docx");
...
Packer.toBuffer(doc).then((buf) => {
  ...
  console.log("wrote Changes_for_review.docx");
});
