...
def main():
    ...
    box(ax, incx, 1.0, incw, 1.4,
        ...
        "206 extracted estimates → 83 representative estimates (one per analytic cell), from 24 studies;\n"
        "the remaining 31 studies contributed only overlapping estimates to the sensitivity analysis",
        fc="#cfe6d4", fs=7.0)
