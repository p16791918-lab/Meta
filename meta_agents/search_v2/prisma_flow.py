...
def main():
    ...
    box(ax, incx, 1.0, incw, 1.4,
        ...
        "218 extracted estimates → 85 representative estimates (one per analytic cell), from 22 studies;\n"
        "the remaining 36 studies contributed only overlapping estimates to the sensitivity analysis",
        fc="#cfe6d4", fs=7.0)
